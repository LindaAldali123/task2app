...
.then(data => {
    ...
    <p>
        ...
        <span class="lab3">`+data[x].city+`</span>
    </p>
    
    <p>
        <label>البلد:</label>
    
        <span class="lab4"> `+data[x].town+`</span>
    </p>
    
    <p>
        <label>نوع العقار:</label>
    
        <span class="lab5">`+data[x].type+` </span>
    </p>
    
    <p>
        <label>اسم العقار:</label>
    
        <span class="lab6">` +data[x].name+`</span>
    </p>
    
    <p>
        <label>الوصف:</label>
    
        <span class="lab7">` +data[x].city+` - `+data[x].town+`<br>
            `+data[x].description+`</span>
            <br>
            <button class="reject" >رفض</button>
            <button class="emphasis" onclick="setId(`+data[x].id+`)">تأكيد</button> <br>` 
        +
      `
            <span class="time">
